...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b9b458, const void *arg_0xb7b9b5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b4c8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79f6840), 
int (*key_eq_fn)(void *arg_0xb79f6c88, void *arg_0xb79f6e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78c59b8, int arg_0xb78c5b10);
static double RandomUniform(void );
...
typedef TMilli FinalProjectC$LocalTime$precision_tag;
typedef TMilli FinalProjectC$MilliTimer$precision_tag;
...
static void FinalProjectC$AMControl$startDone(error_t error);
#line 138
static void FinalProjectC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void FinalProjectC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void FinalProjectC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void FinalProjectC$MilliTimer$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t FinalProjectC$AMControl$start(void );
...
FinalProjectC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t FinalProjectC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 61 "/opt/tinyos-main-2.1.2/tos/lib/timer/LocalTime.nc"
static uint32_t FinalProjectC$LocalTime$get(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void FinalProjectC$MilliTimer$startPeriodic(uint32_t dt);
# 21 "FinalProjectC.nc"
message_t FinalProjectC$packet[1000];
uint8_t FinalProjectC$i[1000];
uint8_t FinalProjectC$current_id[1000];
bool FinalProjectC$locked[1000];
uint8_t FinalProjectC$index[1000];
uint8_t FinalProjectC$last_index[1000];
uint32_t FinalProjectC$current_time[1000];


uint8_t FinalProjectC$ids_received[1000][50];
uint8_t FinalProjectC$counters[1000][50];
uint32_t FinalProjectC$last_times[1000][50];

static inline void FinalProjectC$initializeArrays(void );
static inline uint8_t FinalProjectC$checkIDPresent(uint8_t received_id);
static inline uint8_t FinalProjectC$retrieveLastFreeId(void );
static inline void FinalProjectC$processMessage(uint8_t received_id, uint32_t _time);


static inline void FinalProjectC$Boot$booted(void );
...
static inline void FinalProjectC$AMControl$startDone(error_t err);
...
static inline void FinalProjectC$MilliTimer$fired(void );
#line 82
static inline void FinalProjectC$initializeArrays(void );
#line 94
static inline uint8_t FinalProjectC$checkIDPresent(uint8_t received_id);
...
static inline void FinalProjectC$processMessage(uint8_t received_id, uint32_t _time);
#line 195
static inline message_t *FinalProjectC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 213
static inline void FinalProjectC$AMSend$sendDone(message_t *bufPtr, error_t error);





static inline void FinalProjectC$AMControl$stopDone(error_t err);
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
enum SerialActiveMessageC$__nesc_unnamed4339 {
#line 67
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
#line 57
#line 55
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4343 {
  message_t * msg;
...
#line 107
{
  FinalProjectC$index[sim_node()] = 60;
  for (FinalProjectC$i[sim_node()] = 0; FinalProjectC$i[sim_node()] < 50 - 1; FinalProjectC$i[sim_node()]++) {
      if (FinalProjectC$ids_received[sim_node()][FinalProjectC$i[sim_node()]] == 60) {
          FinalProjectC$index[sim_node()] = FinalProjectC$i[sim_node()];
          break;
        }
    }

  return FinalProjectC$index[sim_node()];
}
...
#line 94
{
  FinalProjectC$index[sim_node()] = 60;
  for (FinalProjectC$i[sim_node()] = 0; FinalProjectC$i[sim_node()] < 50 - 1; FinalProjectC$i[sim_node()]++) {
      if (FinalProjectC$ids_received[sim_node()][FinalProjectC$i[sim_node()]] == received_id) {
          FinalProjectC$index[sim_node()] = FinalProjectC$i[sim_node()];
          break;
        }
    }
...
#line 120
{
  ...
  FinalProjectC$current_id[sim_node()] = FinalProjectC$checkIDPresent(received_id);
  if (FinalProjectC$current_id[sim_node()] != 60) {
      sim_log_debug(153U, "radio_pack", "The mote %u is already registered in memory of mote %u.\n", received_id, TOS_NODE_ID);

      sim_log_debug(154U, "radio_pack", "Check if the current time is within the range.\n");



      if (_time - FinalProjectC$last_times[sim_node()][FinalProjectC$current_id[sim_node()]] > 520) {

          sim_log_debug(155U, "radio_pack", "The mote %u sent its message %u milliseconds ago.\n", received_id, _time - FinalProjectC$last_times[sim_node()][FinalProjectC$current_id[sim_node()]]);


          sim_log_debug(156U, "radio_pack", "Its counter is reset\n");

          FinalProjectC$counters[sim_node()][FinalProjectC$current_id[sim_node()]] = 1;
          FinalProjectC$last_times[sim_node()][FinalProjectC$current_id[sim_node()]] = _time;
        }
      else 
#line 139
        {

          FinalProjectC$counters[sim_node()][FinalProjectC$current_id[sim_node()]] = FinalProjectC$counters[sim_node()][FinalProjectC$current_id[sim_node()]] + 1;
          FinalProjectC$last_times[sim_node()][FinalProjectC$current_id[sim_node()]] = _time;
          sim_log_debug(157U, "radio_pack", "Counter for mote %u in mote %u is %u.\n", received_id, TOS_NODE_ID, FinalProjectC$counters[sim_node()][FinalProjectC$current_id[sim_node()]]);

          if (FinalProjectC$counters[sim_node()][FinalProjectC$current_id[sim_node()]] == 10) {


              sim_log_debug(158U, "radio_pack", "Alarm!!! The mote %u is passing message to Node-Red. message: %u,%u.\n", TOS_NODE_ID, TOS_NODE_ID, received_id);



              sim_log_debug(159U, "radio_pack", "The forwading operation from mote %u is done. message: %u,%u.\n", TOS_NODE_ID, TOS_NODE_ID, received_id);


              sim_log_debug(160U, "radio_pack", "The mote %u reset the counter for mote %u.\n", TOS_NODE_ID, received_id);
              FinalProjectC$counters[sim_node()][FinalProjectC$current_id[sim_node()]] = 0;
            }
        }
    }
  else 
    {
      sim_log_debug(161U, "radio_pack", "The mote %u is not registered in memory of mote %u.\n", received_id, TOS_NODE_ID);

      sim_log_debug(162U, "radio_pack", "Registering mote %u in memory of mote %u...\n", received_id, TOS_NODE_ID);

      FinalProjectC$last_index[sim_node()] = FinalProjectC$retrieveLastFreeId();
      if (FinalProjectC$last_index[sim_node()] != 60) {
          sim_log_debug(163U, "radio_pack", "Memory available in %u : Registering mote %u...\n", TOS_NODE_ID, received_id);


          FinalProjectC$counters[sim_node()][FinalProjectC$last_index[sim_node()]] = 1;
          FinalProjectC$ids_received[sim_node()][FinalProjectC$last_index[sim_node()]] = received_id;
          FinalProjectC$last_times[sim_node()][FinalProjectC$last_index[sim_node()]] = _time;
          sim_log_debug(164U, "radio_pack", "Registering of mote %u finished.\n", received_id);
        }
      else {
          sim_log_debug(165U, "radio_pack", "Memory not available in %u : discarding the old registered mote %u...\n", TOS_NODE_ID, FinalProjectC$ids_received[sim_node()][0]);


          for (FinalProjectC$i[sim_node()] = 0; FinalProjectC$i[sim_node()] < 50 - 2; FinalProjectC$i[sim_node()]++) {
              FinalProjectC$ids_received[sim_node()][FinalProjectC$i[sim_node()]] = FinalProjectC$ids_received[sim_node()][FinalProjectC$i[sim_node()] + 1];
              FinalProjectC$counters[sim_node()][FinalProjectC$i[sim_node()]] = FinalProjectC$counters[sim_node()][FinalProjectC$i[sim_node()] + 1];
              FinalProjectC$last_times[sim_node()][FinalProjectC$i[sim_node()]] = FinalProjectC$last_times[sim_node()][FinalProjectC$i[sim_node()] + 1];
            }
          sim_log_debug(166U, "radio_pack", "Memory available now in %u : Registering mote %u...\n", TOS_NODE_ID, received_id);
          FinalProjectC$counters[sim_node()][50 - 1] = 1;
          FinalProjectC$ids_received[sim_node()][50 - 1] = received_id;
          FinalProjectC$last_times[sim_node()][50 - 1] = _time;
          sim_log_debug(167U, "radio_pack", "Registering of mote %u finished.\n", received_id);
        }
    }
}
...
# 61 "/opt/tinyos-main-2.1.2/tos/lib/timer/LocalTime.nc"
inline static uint32_t FinalProjectC$LocalTime$get(void ){
#line 61
  unsigned int __nesc_result;
#line 61
...
{
  if (len != sizeof(msg_t )) {
      sim_log_debug(168U, "radio_rec", "The mote %u received malformed packet.\n", TOS_NODE_ID);
      return bufPtr;
    }
  else {
...
#line 203
      FinalProjectC$current_time[sim_node()] = FinalProjectC$LocalTime$get();
      sim_log_debug(169U, "radio_rec", "The mote %u received packet from mote %u.\n", TOS_NODE_ID, __nesc_ntoh_uint8(rcm->mote_id.nxdata));


      FinalProjectC$processMessage(__nesc_ntoh_uint8(rcm->mote_id.nxdata), FinalProjectC$current_time[sim_node()]);
      return bufPtr;
    }
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7669ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7669ac8) {
#line 78
    case 6:
#line 78
      __nesc_result = FinalProjectC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7669ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7666178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7666178, msg, payload, len);
#line 78
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void FinalProjectC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 82
{
  ...
  for (FinalProjectC$i[sim_node()] = 0; FinalProjectC$i[sim_node()] < 50 - 1; FinalProjectC$i[sim_node()]++) {
      ...
      FinalProjectC$ids_received[sim_node()][FinalProjectC$i[sim_node()]] = 60;
      FinalProjectC$counters[sim_node()][FinalProjectC$i[sim_node()]] = 0;
      FinalProjectC$last_times[sim_node()][FinalProjectC$i[sim_node()]] = 0;
    }
}
...
#line 48
{
  sim_log_debug(149U, "radio", "The radio module for mote %u is active.\n", TOS_NODE_ID);

  FinalProjectC$initializeArrays();

  FinalProjectC$MilliTimer$startPeriodic(500);
}

# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static void TossimPacketModelC$Control$startDone(error_t error){
#line 113
  FinalProjectC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  FinalProjectC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7669108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7669108, msg, error);
#line 110
}
#line 110
...
#line 213
{
  if (&FinalProjectC$packet[sim_node()] == bufPtr) {
      FinalProjectC$locked[sim_node()] = FALSE;
    }
}

# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  FinalProjectC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7339ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7339ca8) {
#line 100
    case 0U:
#line 100
      /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7339ca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7821650){
#line 75
  switch (arg_0xb7821650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7821650);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7336730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7336730, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t FinalProjectC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*FinalProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * FinalProjectC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 57
{
  sim_log_debug(150U, "radio", "The mote %u timer is fired.\n", TOS_NODE_ID);
  if (FinalProjectC$locked[sim_node()]) {
      return;
    }
  else {

      msg_t *rcm = (msg_t *)FinalProjectC$Packet$getPayload(&FinalProjectC$packet[sim_node()], sizeof(msg_t ));

#line 65
      if (rcm == (void *)0) {
          sim_log_debug(151U, "radio", "Mote %u: error while creating a message. No message will be sent.\n", TOS_NODE_ID);
          return;
        }


      __nesc_hton_uint8(rcm->mote_id.nxdata, TOS_NODE_ID);
      if (FinalProjectC$AMSend$send(AM_BROADCAST_ADDR, &FinalProjectC$packet[sim_node()], sizeof(msg_t )) == SUCCESS) {
          sim_log_debug(152U, "radio", "The message sent from mote %u in broadcast.\n", TOS_NODE_ID);

          FinalProjectC$locked[sim_node()] = TRUE;
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73cb3a8){
#line 83
  switch (arg_0xb73cb3a8) {
#line 83
    case 0U:
#line 83
      FinalProjectC$MilliTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73cb3a8);
#line 83
      break;
#line 83
    }
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t FinalProjectC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 40
{
  ...
  sim_log_debug(148U, "boot", "The mote %u: has booted.\n", TOS_NODE_ID);

  FinalProjectC$AMControl$start();
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "FinalProjectC$packet"))
  {
    *addr = (uintptr_t)&FinalProjectC$packet[__nesc_mote];
    *size = sizeof(FinalProjectC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FinalProjectC$i"))
  {
    *addr = (uintptr_t)&FinalProjectC$i[__nesc_mote];
    *size = sizeof(FinalProjectC$i[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FinalProjectC$current_id"))
  {
    *addr = (uintptr_t)&FinalProjectC$current_id[__nesc_mote];
    *size = sizeof(FinalProjectC$current_id[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FinalProjectC$locked"))
  {
    *addr = (uintptr_t)&FinalProjectC$locked[__nesc_mote];
    *size = sizeof(FinalProjectC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FinalProjectC$index"))
  {
    *addr = (uintptr_t)&FinalProjectC$index[__nesc_mote];
    *size = sizeof(FinalProjectC$index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FinalProjectC$last_index"))
  {
    *addr = (uintptr_t)&FinalProjectC$last_index[__nesc_mote];
    *size = sizeof(FinalProjectC$last_index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FinalProjectC$current_time"))
  {
    *addr = (uintptr_t)&FinalProjectC$current_time[__nesc_mote];
    *size = sizeof(FinalProjectC$current_time[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FinalProjectC$ids_received"))
  {
    *addr = (uintptr_t)&FinalProjectC$ids_received[__nesc_mote];
    *size = sizeof(FinalProjectC$ids_received[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FinalProjectC$counters"))
  {
    *addr = (uintptr_t)&FinalProjectC$counters[__nesc_mote];
    *size = sizeof(FinalProjectC$counters[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FinalProjectC$last_times"))
  {
    *addr = (uintptr_t)&FinalProjectC$last_times[__nesc_mote];
    *size = sizeof(FinalProjectC$last_times[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module FinalProjectC */
  memset((void *)&FinalProjectC$packet[__nesc_mote], 0, sizeof FinalProjectC$packet[__nesc_mote]);
  memset((void *)&FinalProjectC$i[__nesc_mote], 0, sizeof FinalProjectC$i[__nesc_mote]);
  FinalProjectC$current_id[__nesc_mote] = 60;
  memset((void *)&FinalProjectC$locked[__nesc_mote], 0, sizeof FinalProjectC$locked[__nesc_mote]);
  memset((void *)&FinalProjectC$index[__nesc_mote], 0, sizeof FinalProjectC$index[__nesc_mote]);
  memset((void *)&FinalProjectC$last_index[__nesc_mote], 0, sizeof FinalProjectC$last_index[__nesc_mote]);
  memset((void *)&FinalProjectC$current_time[__nesc_mote], 0, sizeof FinalProjectC$current_time[__nesc_mote]);
  memset((void *)&FinalProjectC$ids_received[__nesc_mote], 0, sizeof FinalProjectC$ids_received[__nesc_mote]);
  memset((void *)&FinalProjectC$counters[__nesc_mote], 0, sizeof FinalProjectC$counters[__nesc_mote]);
  memset((void *)&FinalProjectC$last_times[__nesc_mote], 0, sizeof FinalProjectC$last_times[__nesc_mote]);
